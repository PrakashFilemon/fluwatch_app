  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-2">
        <p className="text-2xl font-bold" style={{ color: "#1a2e2c" }}>
          {nilai}
        </p>
        {trend !== undefined && (
          <span
            className="text-xs font-semibold mb-0.5"
            style={{ color: warnaTrend }}
          >
            {trend >= 0 ? `↑ +${trend}%` : `↓ ${trend}%`}
          </span>
        )}
        {badge && (
          <span
            className="text-xs font-bold px-2 py-0.5 rounded mb-0.5"
            style={{
              background: badgeWarna + "22",
              color: badgeWarna,
              border: `1px solid ${badgeWarna}44`,
            }}
          >
            {badge}
          </span>
...
export default function DashboardStats({ refreshKey = 0, onBukaAI }) {
  ...
  const muat = useCallback(async () => {
    ...
    try {
      const params = lokasi
        ? { lat: lokasi.lat, lng: lokasi.lng, radius_km: 10 }
        : undefined;
      ...
      <div className="p-4 space-y-3 animate-pulse">
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            style={{ background: "rgba(58,142,133,0.08)" }}
          />
        ))}
      </div>
    );
  ...
  if (kasus >= 25)
    ...
    insightTeks = `Terdeteksi ${kasus} kasus aktif. Gejala dominan: ${
      stat?.gejala_dominan?.[0]
        ? LABEL_GEJALA[stat.gejala_dominan[0].gejala] ||
          stat.gejala_dominan[0].gejala
        : "demam"
    }. Waspadai potensi penyebaran lebih lanjut.`;
  else
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div
        ...
        style={{ borderBottom: "1px solid rgba(58,142,133,0.12)" }}
      >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-bold" style={{ color: "#1a2e2c" }}>
                {statusTeks}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2">
              <div
                ...
                style={{
                  background: "#f0faf9",
                  border: "1px solid rgba(58,142,133,0.10)",
                }}
              >
                <p className="text-xl font-bold" style={{ color: "#1a2e2c" }}>
                  {stat.area.kasus_48jam}
                </p>
              ...
              >
                <p className="text-xl font-bold" style={{ color: "#3A8E85" }}>
                  {stat.area.pengguna_unik}
                </p>
                <p className="text-xs mt-0.5" style={{ color: "#64748b" }}>
                  Pelapor Unik
                </p>
        ...
        <div
          ...
          style={{
            ...
            border: "1px solid rgba(58,142,133,0.15)",
            borderLeft: "3px solid #3A8E85",
          }}
        >
          <div className="flex items-center gap-2 mb-2">
            <span style={{ color: "#3A8E85" }}>✦</span>
            <h3
              className="text-xs font-bold uppercase tracking-widest"
              style={{ color: "#3A8E85" }}
            >
          ...
          <div>
            ...
            <div className="space-y-2">
              {stat.peringatan.map((p, i) => {
                ...
                const jamStr = waktuTs.toLocaleTimeString("id-ID", {
                  hour: "2-digit",
                  minute: "2-digit",
                });
                const judulMap = {
